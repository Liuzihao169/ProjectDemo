package com.onezero.qa.controller;
import java.util.Map;

import com.onezero.qa.client.LableServiceClient;
...
import com.onezero.qa.service.ProblemService;
...
public class ProblemController {
	...
	@Autowired
    private LableServiceClient lableClient;
    /**
     * 查询标签
     */
	...
	public Result newlist(@PathVariable(value = "label") String label,
	...
	public Result hotlist(@PathVariable(value = "label") String label,
						  @PathVariable(value = "page") int page,
						  @PathVariable(value ="size") int size){
	...
	public Result waitlist(@PathVariable(value = "label") String label,
						  @PathVariable(value = "page") int page,
						  @PathVariable(value ="size") int size){
