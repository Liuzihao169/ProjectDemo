package com.onezero.recruit.controller;
...
import com.onezero.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result recommend(){
		List<Recruit> list = recruitService.findTop4ByStateOrderByCreatetimeDesc("2");// 0：关闭 1:开启 2：推荐
		return new Result(true,StatusCode.OK,"查询成功",list);
	}

	@RequestMapping(value = "/search/newlist",method = RequestMethod.GET)
	public Result newlist(){
		List<Recruit> list = recruitService.findTop12ByStateOrderByCreatetimeDesc();
		return new Result(true,StatusCode.OK,"查询成功",list);
	}
}
